...
1. In HACS Store, search for [***barban-dev/midea_dehumidifier***]
...
### Manual
1. Clone this repo
2. Place the `custom_components/midea_dehumidifier` folder into your HA's `custom_components` folder
3. Activate midea_dehumidifier custom integration on your HA's configuration yaml file (see instructions below)
...
* **sensor.midea_dehumidifier_*[Device_ID]*_target_humidity**

By means of the humidifier entity, you can control your appliance whereas the sensor reports the detected current humidity and target humidity of your environment.
